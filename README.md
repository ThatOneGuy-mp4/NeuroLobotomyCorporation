...
3. Create a folder called "ThatOneGuy_NeuroLobotomyCorporation" in the "BaseMods" folder as described in the Lobotomy Mod Manager guide from before. Copy the "NeuroLobotomyCorporation.dll" and "ModConfig.xml" files, and the "Info", "Localize", "Resources", and "StoryData" folders, located in the compiled files for the NeuroLobotomyCorporation project, into this folder.
...
5. Back in the "BaseMods" folder, create a folder called "ThatOneGuy_NeuroLobotomyCorporationEx", then copy the "Equipment" folder from the NeuroLobotomyCorporation project into it. I don't know why it has to be in a seperate folder. It just does.
