...
namespace NeuroLobotomyCorporation.MalkuthSupression
{
    public class MalkuthSuppressionScene : FacilityManagementScene
    {
        ...
        {
            return "change_action_scene|malkuth_suppression|" + ShootManagerialBullet.IsBulletUnlocked() + "|" + GetDayStartContext() + "|" + (CreatureOverloadManager.instance.GetQliphothOverloadLevel() - 1).ToString();
        }
    }
}
