...
namespace NeuroLobotomyCorporation.NetzachSuppression
{
    public class NetzachSuppressionScene : FacilityManagementScene
    {
        ...
        {
            return "change_action_scene|netzach_suppression|" + ShootManagerialBullet.IsBulletUnlocked() + "|" + GetDayStartContext() + "|" + (CreatureOverloadManager.instance.GetQliphothOverloadLevel() - 1).ToString();
        }
    }
}
